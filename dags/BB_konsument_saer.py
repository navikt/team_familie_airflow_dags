...
from kosument_config import bb_saer
...
with DAG(
  ...
  consumer = kafka_consumer_kubernetes_pod_operator(
    task_id = "saerbidrag_hent_kafka_data",
    config = bb_saer.config.format(topic),
...
#   bb_saer_utpakking_dbt = create_dbt_operator(
#      dag=dag,
#      name="utpakking_bb_saer",
#      repo='navikt/dvh_fam_bb',
#      script_path = 'airflow/dbt_run.py',
#      branch=v_branch,
#      dbt_command= """run --select BB_utpakking_saerbidrag.*""",
#      db_schema=v_schema,
#      allowlist=allowlist
#  )

consumer #>> bb_saer_utpakking_dbt
