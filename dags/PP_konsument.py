...
with DAG(
  dag_id="PP_konsument",
  start_date=datetime(2023, 10, 26, 10),
  ...
  consumer = kafka_consumer_kubernetes_pod_operator(
    ...
    config = pp.config,
    #data_interval_start_timestamp_milli="1698224400000", # gir oss alle data som ligger på topicen fra og til (intial last alt på en gang)
