...
with DAG(
  ...
  consumer = kafka_consumer_kubernetes_pod_operator(
    ...
    config = ks.config,
    data_interval_start_timestamp_milli="1667260800000", # gir oss alle data som ligger på topicen fra og til (intial last alt på en gang)
    data_interval_end_timestamp_milli="1674950400000",   # from first day we got data until 15.11.2022 (todays before todays date)
